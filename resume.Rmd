...
Detail-oriented individual with years of experience in data analysis, visualization, and modeling with a variety of data types
including categorical, longitudinal, disease data, social network data, and spatial data. Looking to leverage this experience with a
role in public health as a statistician or statistical programmer.

## Education

* **Statistics M.S.**, University of California, Irvine Estimated Completion March 2023
    + Coursework in Probability and Statistical Theory, Statistical Methods, Bayesian Data Analysis, Infectious Disease Modeling, Spatial Statistics, Social Network Data, Survival Analysis
...
* **Water Equity Lab Project Policy Analyst** [Water Equity Lab, UC Irvine](https://www.uci.edu/), Jul 2022 - Mar 2023
    + Analyzing and processing vector and raster data pertaining to equitable access to water infrastructure across minority
demographics.
    + Authored and documented functions to streamline productivity in the team.
