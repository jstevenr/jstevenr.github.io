...
Detail-oriented individual with multiple years of experience in data analysis, visualization, and modeling with a variety of data types including categorical, longitudinal, disease data, social network data, and spatial data, and strong background in R programming. Looking for a full-time position in a programmer or analyst role in which I can leverage my skills and expertise.
