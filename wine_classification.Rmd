...
white2 <- white %>% select(-c("residual.sugar", "density", "total.sulfur.dioxide"))
...
```{r final-comparison, fig.cap = "Scatterplot comparing AUC and Accuracy Rate of all models.", fig.width = 10, echo = FALSE}
