...
```{r, initial plot}
set.seed(100)
bitcoin <- read.csv("~/Workspace/project/bitcoin_price.csv")
...
```{r, finding best lambda, fig.height=4}
par(mfrow = c(1,1))
...
```{r, box-cox transformation, fig.height = 3}
...
```{r, ACF-PACF of differenced data, fig.height = 3}
par(mfrow = c(1,2))
...
```{r, spec.arma and plot.roots, fig.height=5}
