...
```{r, data cleaning}
all_movies <- read.csv(here::here("data", "movie_metadata.csv"),
...
stats <- matrix(
  data = NA, nrow = 6, ncol = 7,
  dimnames = list(
    c("1927-2016", "1980-2016", "2010-2016", "2000-2010", "1990-2000", "1980-1990"),
