...
stats <- matrix(data = NA, nrow = 6, ncol = 6, 
                dimnames = list(c("1927-2016", "1980-2016","2010-2016", "2000-2010", "1990-2000","1980-1990"),
                                c("Min", "1Q", "Med", "Mean", "3Q", "Max")))

stats[1,] <- round(summary(all_movies$imdb_score), 2)
all_avg <- stats[1,4]
```
...
stats[2,] <- round(summary(movies$imdb_score), 2)
...
nrow(tens)
stats[3,]<- round(summary(tens$imdb_score), 2)
stats
```
...
nrow(zeroes)
stats[4,]<- round(summary(zeroes$imdb_score), 2)
stats
```
...
nrow(nineties)
stats[5,]<- round(summary(nineties$imdb_score), 2)
stats
```
...
nrow(eighties)
stats[6,]<- round(summary(eighties$imdb_score), 2)
stats
```
